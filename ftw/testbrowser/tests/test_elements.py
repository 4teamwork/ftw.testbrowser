...
class TestBrowserRequestsMechanize(BrowserTestCase):
    ...
    def test_find_link_by_text(self, browser):
        ...
        self.assertEqual('link/target', browser.find('A link').attrib['href'])
    ...
    def test_find_textfield_by_label(self, browser):
        browser.visit(view='test-elements')
        self.assertEqual('field value', browser.find('A textfield').value)

    @browsing
    def test_find_textfield_by_name(self, browser):
        browser.visit(view='test-elements')
        self.assertEqual('field value', browser.find('textfield').value)

    @browsing
    def test_find_textarea_by_label(self, browser):
        browser.visit(view='test-elements')
        self.assertEqual('Text area value', browser.find('A textarea').text)

    @browsing
    def test_find_textarea_by_name(self, browser):
        browser.visit(view='test-elements')
        self.assertEqual('Text area value', browser.find('textarea').text)

    @browsing
    def test_find_checkbox_by_label(self, browser):
        browser.visit(view='test-elements')
        self.assertEqual(True, browser.find('Checkbox').checked)

    @browsing
    def test_find_checkbox_by_text(self, browser):
        browser.visit(view='test-elements')
        self.assertEqual(True, browser.find('box').checked)

    @browsing
    def test_find_button_by_label(self, browser):
        browser.visit(view='test-elements')
        self.assertEqual('A button', browser.find('A button').value)

    @browsing
    def test_no_element_found_returns_None(self, browser):
        browser.visit(view='test-elements')
        self.assertEqual(None, browser.find('Something missing'))
